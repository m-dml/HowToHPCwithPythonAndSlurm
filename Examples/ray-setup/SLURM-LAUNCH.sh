...
#### call your code below. If you are using anaconda environments I always find it best to
#### directly call them with full path:
/gpfs/home/machnitz/miniconda3/envs/plankton/bin/python ../RayExample.py
exit